...
struct EmojiArtDocumentView: View {
    ...
    var isSomethingSelcted: Bool {
        selected.isEmpty ? false : true
    }
    
    let defaultEmojiFontSize: CGFloat = 40
    let defaultSelectBackCircleSize: CGFloat = 50
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        EmojiArtDocumentView(document: EmojiArtDocument(), selected: Set<EmojiArtModel.Emoji>())
    }
}
